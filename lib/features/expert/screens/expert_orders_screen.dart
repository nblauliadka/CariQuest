// lib/features/expert/screens/expert_orders_screen.dart
...
class ExpertOrdersScreen extends ConsumerWidget {
  const ExpertOrdersScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final questsAsync = ref.watch(expertActiveQuestsProvider);
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Quest yang sedang kamu kerjakan\nakan muncul di sini',
                    style: TextStyle(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  'Rp ${fmt(quest.minBudget)}–${fmt(quest.maxBudget)}',
                  style: const TextStyle(
